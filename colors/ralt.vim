hi clear
syntax reset
let g:colors_name = "ralt_python_enhanced"
set background=dark
set t_Co=256
...
hi String guifg=#eeee77 guibg=NONE
...
" Décorateurs (bleu dominant version claire/foncée)
hi pythonDecorator        guifg=#33bbff gui=bold
hi pythonDecoratorName    guifg=#0077cc gui=bold

" Strings (jaune family variation)
hi pythonString           guifg=#eeee77
hi pythonRawString        guifg=#f0f088
hi pythonTripleString     guifg=#dada66
hi pythonEscape           guifg=#ff5577

" Types logiques
hi pythonBoolean          guifg=#00ffb6 gui=bold
hi pythonNone             guifg=#ff4444 gui=bold

" Fonctions / classes (rose / rouge dégradés)
hi pythonFunction         guifg=#ff8888 gui=bold
hi pythonClass            guifg=#fc7575 gui=bold
hi pythonSuperclass       guifg=#e05a5a gui=bold

" Builtins / flux / import (bleu et verts différenciés)
hi pythonBuiltin          guifg=#00aaff
hi pythonConditional      guifg=#33dd88 gui=bold
hi pythonRepeat           guifg=#22bb77 gui=bold
hi pythonImport           guifg=#00ffb6 gui=bold

" Opérateurs / Exceptions
hi pythonOperator         guifg=#cc8844
